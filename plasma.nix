{
  programs.plasma = {
    enable = true;
    #overrideConfig = true; # enable for it to regenerate the config on every login (would be good if it actually worked)
    ...
    shortcuts = {
      ActivityManager.switch-to-activity-03d653e6-300e-4e9b-b7b3-3e3bd06e8350 = [ ];
      ...
      "services/net.local.flameshot.desktop"._launch = "Print";
    ...
    configFile = {
      ...
      kiorc."Executable scripts".behaviourOnLaunch = "execute"; # figure these out, they look important
      ...
      plasmanotifyrc."Applications/vesktop".ShowInHistory = false;
      plasmanotifyrc."Applications/vesktop".ShowPopups = false;
